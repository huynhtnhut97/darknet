...
mypath = '/home/nhuthuynh/darknet_alexeyAB/darknet/data/VisDrone2018-VID-val/annotations/uav0000182_00000_v/'
outpath = '/home/nhuthuynh/darknet_alexeyAB/darknet/data/VisDrone2018-VID-val/sequences/uav0000182_00000_v/'
...
for txt_name in txt_name_list:
    ...
    for line in lines:
        ...
        if(len(line) >= 2):
            ...
            #
            img_path = str('/home/nhuthuynh/darknet_alexeyAB/darknet/data/VisDrone2018-VID-val/sequences/uav0000182_00000_v/%s.jpg'%(os.path.splitext(txt_name)[0]))
            print(str(img_path))
